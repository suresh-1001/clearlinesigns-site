...
(function () {
  ...
  var NAV = '<nav id="mainNav"><div class="nav-inner"><a href="' + base + 'index.html" class="logo"><img src="' + base + 'assets/images/logo.webp" alt="Clear Line Signs" width="160" height="40" /></a><ul class="nav-links" id="navLinks"><li><a href="' + base + 'index.html" class="' + isActive('index') + '">Home</a></li><li><a href="' + base + 'services.html" class="' + isActive('services') + '">Services</a></li><li><a href="' + base + 'products/index.html" class="' + isActive('products') + '">Products</a></li><li><a href="' + base + 'portfolio.html" class="' + isActive('portfolio') + '">Portfolio</a></li><li><a href="' + base + 'about.html" class="' + isActive('about') + '">About</a></li><li><a href="https://clearlinesigns.com/blog/">Blog</a></li><li><a href="' + base + 'sign-copy-generator.html" class="' + isActive('sign-copy-generator') + '">Sign Copy Tool</a></li><li><a href="' + base + 'design-brief.html" class="' + isActive('design-brief') + '">Design Brief</a></li><li><a href="' + base + 'pricing.html" class="' + isActive('pricing') + '">Pricing Guide</a></li><li><a href="tel:4087801035" class="nav-phone">(408) 780-1035</a></li><li><a href="' + base + 'contact.html" class="nav-cta ' + isActive('contact') + '">Free Quote</a></li></ul><button class="hamburger" id="hamburger" aria-label="Menu"><span></span><span></span><span></span></button></div></nav>';
